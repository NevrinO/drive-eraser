...
- **Mandatory Action**: If `CRITIQUE.md` exists, you must:
  ...
  3. Once resolved, append a `## Resolution Log` to `CRITIQUE.md` explaining how you solved the flaws, or delete the file if fully resolved.
...
- **Trigger**: Activated when the user uses keywords like "critique", "review recent changes", or "run audit".
- **Mandatory Action**:

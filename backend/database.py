...
# SMART snapshot and test functions have been extracted to smart_db.py
# Re-exports below preserve backward compatibility for all external callers
from smart_db import (
    record_intake_snapshot, load_prior_visit, save_wipe_smart_snapshot,
    calculate_smart_diff, record_smart_test_run, get_historical_poh_for_serial,
    update_smart_test_run, get_smart_test_history, cleanup_stale_smart_tests,
    get_smart_test_status_batch

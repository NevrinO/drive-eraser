...
POLICY_SCHEMA = {
    ...
    "properties": {
        ...
        "zero_check_timeout_seconds": {"type": "integer", "minimum": 5, "maximum": 300},
        "zero_check_startup_delay_seconds": {"type": "integer", "minimum": 0, "maximum": 300},
        ...
        "triage_thresholds": {
            ...
            "properties": {
                ...
                "health_score_good_threshold": {"type": "integer", "minimum": 0},

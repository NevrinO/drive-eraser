...
class TestGetAdminBayMap:
    ...
    def test_get_bay_map_success(self, mock_auth, mock_compose, mock_normalize, mock_get_dir):
    ...
    @patch('routes.bay_mapping_routes.compose_bay_map_document')
    @patch('routes.admin_routes.require_admin_auth')
    def test_get_bay_map_missing_file(self, mock_auth, mock_compose, mock_normalize, mock_get_dir):
    ...
    @patch('routes.bay_mapping_routes.get_config_dir')
    @patch('routes.admin_routes.require_admin_auth')
    def test_get_bay_map_error(self, mock_auth, mock_get_dir):
...
class TestGetUnmappedDrives:
    ...
    @patch('routes.bay_mapping_routes.get_smart_data')
    @patch('routes.admin_routes.require_admin_auth')
    def test_get_unmapped_drives_success(self, mock_auth, mock_smart, mock_os, mock_normalize, mock_get_dir):
        """Test successful unmapped drives retrieval."""
        from routes.bay_mapping_routes import bay_mapping_bp
        from flask import Flask
    ...
    @patch('routes.bay_mapping_routes.normalize_bay_map_document')
    @patch('routes.admin_routes.require_admin_auth')
    def test_get_unmapped_drives_error(self, mock_auth, mock_normalize, mock_get_dir):
...
class TestAutoDetectBays:
    ...
    @patch('routes.bay_mapping_routes.compose_bay_map_document')
    @patch('routes.admin_routes.require_admin_auth')
    def test_auto_detect_bays_no_slots(self, mock_auth, mock_compose, mock_save, mock_normalize, mock_get_dir):
    ...
    @patch('routes.bay_mapping_routes.compose_bay_map_document')
    @patch('routes.admin_routes.require_admin_auth')
    def test_auto_detect_bays_with_slots(self, mock_auth, mock_compose, mock_save, mock_normalize, mock_get_dir):
    ...
    @patch('routes.bay_mapping_routes.get_config_dir')
    @patch('routes.admin_routes.require_admin_auth')
    def test_auto_detect_bays_error(self, mock_auth, mock_get_dir):
...
class TestUpdateBayMap:
    ...
    @patch('routes.bay_mapping_routes.compose_bay_map_document')
    @patch('routes.admin_routes.require_admin_auth')
    def test_update_bay_map_success(self, mock_auth, mock_compose, mock_save, mock_validate, mock_normalize, mock_templates, mock_get_dir):
    ...
    @patch('routes.bay_mapping_routes.get_config_dir')
    @patch('routes.admin_routes.require_admin_auth')
    def test_update_bay_map_invalid_payload(self, mock_auth, mock_get_dir):
    ...
    @patch('routes.bay_mapping_routes.normalize_bay_map_document')
    @patch('routes.admin_routes.require_admin_auth')
    def test_update_bay_map_no_bays(self, mock_auth, mock_normalize, mock_templates, mock_get_dir):
    ...
    @patch('routes.bay_mapping_routes.get_config_dir')
    @patch('routes.admin_routes.require_admin_auth')
    def test_update_bay_map_error(self, mock_auth, mock_get_dir):
